  ...
  <div class="articleDetail-container">
    <div class="header-section">
      <div class="header-content">
        <el-image :src="book" style="width: 60px; height: 60px"> </el-image>
      </div>
    </div>
    <div class="content">
      ...
      <div class="diary-card">
        ...
        >
          ...
          <div class="tag-list">
            <el-tag v-for="tag in articleDetail.tagArray" :key="tag" class="tag-item" type="info" effect="light">
              {{ tag }}
            </el-tag>
          </div>
        </div>
...
import { getKnowledgeDetail } from "../api/forntend";
